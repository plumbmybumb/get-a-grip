...
Living documents sit at this level. Dated records move into the folders below once
the release or audit they describe has shipped.
...
| `previews/` | Design previews for work in progress |

## History

| Folder | What it holds |
| --- | --- |
| `releases/<version>/` | The store listing text shipped with each version |
| `releases/notes/` | Dated release records and "what's new" drafts, one per submission |
| `audits/` | Dated source audits and their dispositions |
