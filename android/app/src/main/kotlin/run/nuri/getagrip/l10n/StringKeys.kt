...
private fun string_keysChunk0(into: MutableMap<String, Int>) {
    ...
    into["%1\$d of %2\$d pulls done"] = R.string.s_lld_of_lld_pulls_done
    ...
    into["%d of %d pulls done"] = R.string.s_lld_of_lld_pulls_done
...
private fun string_keysChunk1(into: MutableMap<String, Int>) {
    ...
    into["%s HAND NEXT"] = R.string.s_hand_next
    ...
    into["%s broadcasts its weight instead of connecting, so there's nothing to pair. Tare works in the app. Sessions pause when you leave the app."] = R.string.s_broadcasts_its_weight_instead_of_connecting_so_there_s_n
    ...
    into["%s. Delete"] = R.string.a_s_delete
    ...
    into["24 pulls on one hand, then 24 on the other. About 8 minutes, one result per hand."] = R.string.s_24_pulls_on_one_hand_then_24_on_the_other_about_8_minute
    into["24 pulls · 7 s on · 3 s off"] = R.string.s_24_pulls_7_s_on_3_s_off
    ...
    into["7 s on, 3 s off, with no pauses. The result depends on that rhythm, so rests don't wait for you. Force after the bell isn't counted."] = R.string.s_7_s_on_3_s_off_with_no_pauses_the_result_depends_on_that
    into["A CSV for your AI assistant or spreadsheet. Summary groups pulls by set and hand."] = R.string.s_a_csv_for_your_ai_assistant_or_spreadsheet_summary_group
    ...
    into["A max is your hardest pull on a grip."] = R.string.s_a_max_is_your_hardest_pull_on_a_grip
    into["A max is your hardest pull. Critical force is the four-minute endurance test."] = R.string.s_a_max_is_your_hardest_pull_critical_force_is_the_four_mi
    into["A max or critical force test on the gauge."] = R.string.s_a_max_or_critical_force_test_on_the_gauge
    ...
    into["All critical force tests on %s"] = R.string.s_all_critical_force_tests_on
    into["All history"] = R.string.s_all_history
    into["All pulls on one hand, then the other, in each set."] = R.string.s_all_pulls_on_one_hand_then_the_other_in_each_set
    ...
    into["All time. Totals appear after your first session."] = R.string.s_all_time_totals_appear_after_your_first_session
...
private fun string_keysChunk2(into: MutableMap<String, Int>) {
    ...
    into["Body weight"] = R.string.s_body_weight
    into["Both"] = R.string.s_both_1f4698
    into["Both hands"] = R.string.s_both_hands_cb0647
    ...
    into["Can't reach shared storage. Earlier routines may be missing."] = R.string.s_can_t_reach_shared_storage_earlier_routines_may_be_missi
    into["Can't share files on this build. Use Copy instead."] = R.string.a_can_t_share_files_on_this_build_use_copy_instead
    into["Cancel"] = R.string.s_cancel
    into["Change"] = R.string.s_change
    ...
    into["Column names and the data guide are in English."] = R.string.s_column_names_and_the_data_guide_are_in_english
    into["Comfortable"] = R.string.s_comfortable
    into["Connect"] = R.string.s_connect
    into["Connect a gauge and pull to see the force."] = R.string.s_connect_a_gauge_and_pull_to_see_the_force
    into["Connect and start"] = R.string.s_connect_and_start
    into["Connect gauge"] = R.string.s_connect_gauge
    into["Connect to the internet for the Dyno's first calibration."] = R.string.s_connect_to_the_internet_for_the_dyno_s_first_calibration
    into["Connect your gauge to check it."] = R.string.s_connect_your_gauge_to_check_it
    ...
    into["Connect your gauge to test."] = R.string.s_connect_your_gauge_to_test
    into["Connected"] = R.string.s_connected
    into["Connected, but no readings yet. Tap Wake."] = R.string.s_connected_but_no_readings_yet_tap_wake
    ...
    into["Copy your draft and email it to this address."] = R.string.a_copy_your_draft_and_email_it_to_this_address
    ...
    into["Couldn't save the change: %s"] = R.string.s_couldn_t_save_the_change
    into["Couldn't save this routine. Try again."] = R.string.s_couldn_t_save_this_routine_try_again
    into["Couldn't save this workout. Try again."] = R.string.s_couldn_t_save_this_workout_try_again
    into["Couldn't save your maxes. Try again."] = R.string.s_couldn_t_save_your_maxes_try_again
    into["Couldn't save. Try again."] = R.string.s_couldn_t_save_try_again
    ...
    into["Critical force %s %s"] = R.string.s_critical_force_dd9046
    into["Critical force %s %s %s since %s"] = R.string.s_critical_force_since
    into["Critical force %s kilograms"] = R.string.a_critical_force_kilograms_a5fa99
    into["Critical force held since %s"] = R.string.s_critical_force_held_since
    into["Critical force history"] = R.string.s_critical_force_history
    into["Critical force test"] = R.string.s_critical_force_test
    into["Critical force tested %s"] = R.string.s_critical_force_tested
...
private fun string_keysChunk3(into: MutableMap<String, Int>) {
    ...
    into["Each bar is one pull's average. Critical force is the mean of pulls %d–%d."] = R.string.s_each_bar_is_one_pull_s_average_critical_force_is_the_mea
    into["Each device sends its own reminders. A logged session silences them everywhere once synced."] = R.string.s_each_device_sends_its_own_reminders_a_logged_session_sil
    ...
    into["Entered by hand. Check the value and unit."] = R.string.s_entered_by_hand_check_the_value_and_unit
    ...
    into["Every rest kept on the beat."] = R.string.s_every_rest_kept_on_the_beat
    ...
    into["HANDS"] = R.string.s_hands_6be3e4
    ...
    into["Hands swap every pull, left first."] = R.string.s_hands_swap_every_pull_left_first
    into["Hands swap every pull, right first."] = R.string.s_hands_swap_every_pull_right_first
    into["Hands swap every pull."] = R.string.s_hands_swap_every_pull
    into["Hangboard"] = R.string.s_hangboard
    into["Hangs"] = R.string.s_hangs
    into["Hard"] = R.string.s_hard
    into["Hard bouldering or projecting, at your limit."] = R.string.s_hard_bouldering_or_projecting_at_your_limit
...
private fun string_keysChunk4(into: MutableMap<String, Int>) {
    ...
    into["Its sessions are deleted too."] = R.string.s_its_sessions_are_deleted_too
    ...
    into["Keep tests comparable"] = R.string.s_keep_tests_comparable
    ...
    into["Left first"] = R.string.s_left_first
    into["Left hand"] = R.string.s_left_hand
    into["Left hand first, then right, in each set."] = R.string.s_left_hand_first_then_right_in_each_set
    ...
    into["Log a climb or hangs without the gauge"] = R.string.s_log_a_climb_or_hangs_without_the_gauge
    ...
    into["Marks %s as trained and stops its reminders."] = R.string.s_marks_as_trained_and_stops_its_reminders
    ...
    into["Max, both hands together"] = R.string.s_max_both_hands_together
    into["Max, one hand at a time"] = R.string.s_max_one_hand_at_a_time
    into["Maxes"] = R.string.s_maxes_a9b915
    into["Maxes saved, but the targets didn't update. Try again."] = R.string.s_maxes_saved_but_the_targets_didn_t_update_try_again
...
private fun string_keysChunk5(into: MutableMap<String, Int>) {
    ...
    into["No max for this grip yet. Measure one in Benchmarks."] = R.string.s_no_max_for_this_grip_yet_measure_one_in_benchmarks
    into["No max for your %s hand yet. Measure one in Benchmarks."] = R.string.s_no_max_for_your_hand_yet_measure_one_in_benchmarks
    ...
    into["No max yet. Measure one to compare with critical force."] = R.string.s_no_max_yet_measure_one_to_compare_with_critical_force
    ...
    into["No pulls held. Nothing to log."] = R.string.s_no_pulls_held_nothing_to_log
    into["No pulls recorded. Tare the gauge and pull through it."] = R.string.s_no_pulls_recorded_tare_the_gauge_and_pull_through_it
    ...
    into["One at a time"] = R.string.s_one_at_a_time
    into["One at a time: 24 pulls on one hand, then 24 on the other, one result each. Both hands: they pull together through the gauge. Hands never alternate pull by pull; that would change the rhythm."] = R.string.s_one_at_a_time_24_pulls_on_one_hand_then_24_on_the_other
    into["One combined measurement"] = R.string.s_one_combined_measurement
    into["One hand"] = R.string.s_one_hand
    ...
    into["One session so far. The trend starts after two."] = R.string.s_one_session_so_far_the_trend_starts_after_two
    ...
    into["Only your %s hand. The other hand needs its own max."] = R.string.a_only_your_s_hand_the_other_hand_needs_its_own_max
    ...
    into["Opens the live gauge"] = R.string.s_opens_the_live_gauge
    ...
    into["Ported protocols come from the open-source hangtime-grip-connect project and are untested here. Check your first pull against a known weight."] = R.string.s_ported_protocols_come_from_the_open_source_hangtime_grip
    ...
    into["Press and hold to end. Completed pulls are kept."] = R.string.s_press_and_hold_to_end_completed_pulls_are_kept
    into["Press and hold to finish with the pulls done so far."] = R.string.s_press_and_hold_to_finish_with_the_pulls_done_so_far
    into["Press and hold to stop. Before pull 16 there is no result."] = R.string.s_press_and_hold_to_stop_before_pull_16_there_is_no_result
    ...
    into["Pull as hard as you can. The hardest pull is kept, or type a value below."] = R.string.a_pull_as_hard_as_you_can_the_hardest_pull_is_kept_or_type
    ...
    into["RESERVE (W′)"] = R.string.s_reserve_w
...
private fun string_keysChunk6(into: MutableMap<String, Int>) {
    ...
    into["Right hand first, then left, in each set."] = R.string.s_right_hand_first_then_left_in_each_set
    ...
    into["STOPPED"] = R.string.s_stopped_a59e35
    ...
    into["Save your hardest pull as a max"] = R.string.s_save_your_hardest_pull_as_a_max
    into["Save your hardest pulls as maxes"] = R.string.s_save_your_hardest_pulls_as_maxes
    ...
    into["Saves to Photos at %1\$d × %2\$d pixels."] = R.string.a_saves_to_photos_at_d_d_pixels
    into["Saves to Photos at %d × %d pixels."] = R.string.a_saves_to_photos_at_d_d_pixels
    ...
    into["Start %s hand"] = R.string.s_start_hand
    ...
    into["Start in half crimp and curl your fingers into the edge."] = R.string.s_start_in_half_crimp_and_curl_your_fingers_into_the_edge
    into["Start measuring"] = R.string.s_start_measuring
    into["Start next session"] = R.string.a_start_next_session
    ...
    into["Tap Connect to listen for your %s."] = R.string.s_tap_connect_to_listen_for_your
    into["Tap Connect to pair with your %s."] = R.string.s_tap_connect_to_pair_with_your
    into["Tap to choose from %d supported gauges."] = R.string.s_tap_to_choose_from_lld_supported_gauges
...
private fun string_keysChunk7(into: MutableMap<String, Int>) {
    ...
    into["Targets are a percentage of this max. It's a reference, not a safe-load limit."] = R.string.s_targets_are_a_percentage_of_this_max_it_s_a_reference_no
    into["Targets use your saved maxes. Retest when they're out of date."] = R.string.s_targets_use_your_saved_maxes_retest_when_they_re_out_of
    into["Taxed"] = R.string.s_taxed
    into["Terms of use"] = R.string.a_terms_of_use
    into["Test critical force"] = R.string.s_test_critical_force
    ...
    into["Testing day today"] = R.string.s_testing_day_today
    into["Testing day today, plus %d hang sessions"] = R.string.s_testing_day_today_plus_lld_hang_sessions
    into["Testing day today, plus a hang session"] = R.string.s_testing_day_today_plus_a_hang_session
    into["Thank you,"] = R.string.s_thank_you
    into["The app closed before this session was saved."] = R.string.a_the_app_closed_before_this_session_was_saved
    ...
    into["There's %1\$s %2\$s on the gauge. Taring now counts it as zero."] = R.string.s_there_s_on_the_gauge_taring_now_counts_it_as_zero
    into["There's %s %s on the gauge. Taring now counts it as zero."] = R.string.s_there_s_on_the_gauge_taring_now_counts_it_as_zero
    into["There's %s kg on the gauge. Zero it?"] = R.string.s_there_s_kg_on_the_gauge_zero_it
    into["There's %s on the gauge. Let go, then start."] = R.string.s_there_s_on_the_gauge_let_go_then_start
    ...
    into["This Dyno sent no serial number, so its calibration can't be looked up."] = R.string.s_this_dyno_sent_no_serial_number_so_its_calibration_can_t
    into["This build has no Frez access key, so it can't fetch the Dyno's calibration."] = R.string.s_this_build_has_no_frez_access_key_so_it_can_t_fetch_the
    ...
    into["Used for both hands. Pick a hand if yours differ."] = R.string.a_used_for_both_hands_pick_a_hand_if_yours_differ
    ...
    into["Warm up first. Use the same grip and arm position each time. Leave a few weeks between tests; the first is partly practice."] = R.string.s_warm_up_first_use_the_same_grip_and_arm_position_each_ti
    ...
    into["Weighted or max hangs done without the gauge."] = R.string.s_weighted_or_max_hangs_done_without_the_gauge
    ...
    into["Workouts: %1\$d · Pulls: %2\$d · Maxes: %3\$d · Critical force tests: %4\$d"] = R.string.s_workouts_lld_pulls_lld_maxes_lld_critical_force_tests_ll
    into["Workouts: %d · Pulls: %d · Maxes: %d"] = R.string.s_workouts_lld_pulls_lld_maxes_lld
    into["Workouts: %d · Pulls: %d · Maxes: %d · Critical force tests: %d"] = R.string.s_workouts_lld_pulls_lld_maxes_lld_critical_force_tests_ll
    ...
    into["Zero the gauge"] = R.string.s_zero_the_gauge
...
private fun string_keysChunk8(into: MutableMap<String, Int>) {
    ...
    into["heaviest pull %1\$s %2\$s"] = R.string.s_heaviest_pull_a31a89
    into["heaviest pull %s %s"] = R.string.s_heaviest_pull_a31a89
    into["held since %s"] = R.string.s_held_since
    into["hour"] = R.string.s_hour
    into["hours"] = R.string.s_hours
    into["iCloud is unavailable. Data stays on this device and won't sync."] = R.string.s_icloud_is_unavailable_data_stays_on_this_device_and_won
    ...
    into["volume %s"] = R.string.s_volume_4c4813
...
val PLURAL_KEYS: Map<String, Int> = buildMap(19) {
...
private fun plural_keysChunk0(into: MutableMap<String, Int>) {
    ...
    into["%1\$s, %2\$d seconds. %3\$s"] = R.plurals.s_lld_seconds
    into["%d climbing days"] = R.plurals.s_lld_climbing_days
    into["%d days trained"] = R.plurals.s_lld_days_trained
